...
import { getMasterContractApprovalId } from "../src/functions/master-contract-approval";
...
test("Master contract approval creates user and bumps bentobox userCount", () => {
    ...
    let approved = false
    let masterContractApprovalEvent = createMasterContractApprovalEvent(MASTER_DEPLOYER, BOB, false)
